...
type PlaceholderLogoFooterProps = {
    svgStyleKey: string;
    pathStyleKey: string;
}

export default function PlaceholderLogoFooter({ svgStyleKey, pathStyleKey }: PlaceholderLogoFooterProps) {
